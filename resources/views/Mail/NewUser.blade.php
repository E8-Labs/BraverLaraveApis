...
<p style="padding-left: 23px; font-family: 'Lato', sans-serif; font-size:15px">Hey Jonathan,  </p>
<p style="padding-left: 23px; font-family: 'Lato', sans-serif; font-size:15px">A new user <strong>{{$user_name}} </strong>has just registered.</p>
<br/>
<br/>
